...
namespace SuperHumans.ViewModel
{
    public class Account : BaseViewModel
    {
        public Account()
        {
            ...
            // This command is bound to Login Button in Login.xaml and would be fired when that button is clicked
        ...
        public void OnSubmit()
        {
            ...
            {
                MessagingCenter.Send(this, "ErrorMssg", User.UserName);
            }
            else
            {
                MessagingCenter.Send(this, "CorrectMssg", User.UserName);
            }
        }
